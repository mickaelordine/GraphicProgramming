...
//bool ModelClass::Initialize(ID3D11Device* device, ID3D11DeviceContext* deviceContext, EnumDictionary::BufferType type)
//{
//	bool result;
//
//	switch (type) 
//	{
//	case EnumDictionary::BufferType::Square: // Square
//			result = InitializeBuffersSquare(device);
//			if (!result)
//			{
//				return false;
//			}
//			break;
//
//	case EnumDictionary::BufferType::Rectangle: // Rectangle
//			result = InitializeBuffersRect(device, 6.0f,2.0f);
//			if (!result)
//			{
//				return false;
//			}
...
//bool ModelClass::InitializeBuffersSquare(ID3D11Device* device)
//{
//	VertexType* vertices;
...
//bool ModelClass::InitializeBuffersRect(ID3D11Device* device, float width, float height)
//{
//	VertexType* vertices;
//	unsigned long* indices;
//	D3D11_BUFFER_DESC vertexBufferDesc, indexBufferDesc;
